package com.cloudy.androidapi.customdialog;
...
public class CustomAlertController{
    ...
    private void setBackground(LinearLayout topPanel, LinearLayout contentPanel,
        ...
        int fullDark = R.drawable.custom_popup_full;
        int topDark = R.drawable.custom_popup_top;
        int centerDark = R.drawable.custom_popup_center;
        int bottomDark = R.drawable.custom_popup_bottom;
        int fullBright = R.drawable.custom_popup_full;
        int topBright = R.drawable.custom_popup_top;
        int centerBright = R.drawable.custom_popup_center;
        int bottomBright = R.drawable.custom_popup_bottom;
        int bottomMedium = R.drawable.custom_popup_bottom;
