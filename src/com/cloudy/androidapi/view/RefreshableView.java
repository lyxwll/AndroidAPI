...
public class RefreshableView extends LinearLayout implements OnTouchListener {
	...
	public static final int STATUS_RELEASE_TO_REFRESH = 1;// 释放 立即刷新状态
	public static final int STATUS_REFRESHING = 2;// 正在刷新状态
	public static final int STATUS_REFRESH_FINISHED = 3;// 刷新完成或为刷新状态
	...
	private static final String UPDATE_AT = "update_at";// 上次更新时间的字符串常量，用于作为SharedPreferences的键值
